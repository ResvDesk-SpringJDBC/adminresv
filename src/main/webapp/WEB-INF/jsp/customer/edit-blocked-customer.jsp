...
<script type="text/javascript" src="static/js/validation/customer/customerFormValidation.js"></script>
	...
	<form:form name="customerForm" id="customerForm" commandName="customer" method="post" action="update-blocked-customer.html"> 
		<h1>&nbsp;&nbsp;Edit Customer</h1>
		...
		<!--Patient Details starts -->
		 ...
		 <div class="popup-button" id="resvSave">		
				...
				&nbsp; 
				<input name="btnSave" type="button" class="btn" value="Update" id="btnSave" />
		  </div>
	</form:form>