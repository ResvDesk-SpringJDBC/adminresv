...
<title>Customer > Blocked Customer Details</title>
...
<script type="text/javascript">
	$().ready(function() {
	  ...
	  $('.edit').click(function() {	
		  var id = $(this).attr('id');
		  //alert("id :::"+id);
		  $('#ex3').jqm({ajax:'edit-blocked-customer.html?customerId='+id, modal: true,trigger: 'a.ex3trigger'});
	  });
	});
...
<!-- Body starts -->
	<h1>Customer > Blocked Customer Details</h1>
    <!--Search bar starts -->
	<form:form action="blocked-customer-details.html" method="POST" id="custDetailsSearchRequestForm" modelAttribute="custDetailsSearchRequest"> 
	...
	<!--Options starts -->
    <div class="options">
      <div class="txt-bold float-left">Blocked Customer Details</div>
