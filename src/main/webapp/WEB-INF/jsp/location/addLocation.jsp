...
<script type="text/javascript" src="static/js/validation/location/locations.js?version=1.0"></script>
	...
	<form:form name="locationForm" id="locationForm" commandName="location" action="save-location.html" method="post" >
		<h1>&nbsp; &nbsp;Add Location</h1>
		...
		<div class="popup-content">
			...
			<div class="popup-button">				
				...
				&nbsp; 
				<input name="btnSave" type="button" class="btn" value="Save" id="addlocationSaveBtn">
			</div>
			<!-- pop up ends -->
		</div>
	</form:form>